...
router.get('/stock', passport.authenticate('jwt', { session: false }), (req, res) => {
  Stock.getAllStock().then(stock => {
    res.json(stock);
  });
});

router.get('/stockdetails', passport.authenticate('jwt', { session: false }), (req, res) => {
  let id = req.query.id;
...
router.delete('/stock', passport.authenticate('jwt', { session: false }), (req, res) => {
  //console.log(req.query.id);
  let id = req.query.id;
...
router.patch('/stock', passport.authenticate('jwt', { session: false }), (req, res) => {
