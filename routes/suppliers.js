...
router.post('/supplierwsr', passport.authenticate('jwt', { session: false }), (req, res) => {
...
router.get('/supplier_details', passport.authenticate('jwt', { session: false }), (req, res) => {
  let _id = req.query;
...
router.delete('/supplier', passport.authenticate('jwt', { session: false }), (req, res) => {
